...
// Simple version - add this function instead
    const getImageUrl = (url) => {
        console.log('Image URL received:', url);

        if (!url) {
            console.log('No URL provided, using placeholder');
            return 'https://via.placeholder.com/75x95/4A90E2/FFFFFF?text=Poster';
        }
        ...
        // If it's a relative path, add the server URL
                                        ...
                                        <div key={item.id} className="co-item">
                                            <img
                                                ...
                                                onError={(e) => {
                                                    ...
                                                    e.target.src = 'https://via.placeholder.com/75x95/4A90E2/FFFFFF?text=Poster';
                                                    e.target.alt = `Failed to load: ${item.title}`;
                                                }}
                                            />
